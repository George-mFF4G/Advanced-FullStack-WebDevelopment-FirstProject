...
app.get('/api/images', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name, imageName, imageWidth, imageHeight, oldImagePath, newpath;
        ...
        switch (_a.label) {
            case 0:
                ...
                if (!(!fs_1.default.existsSync(oldImagePath) &&
                    imageWidth > 0 &&
                    imageHeight > 0)) return [3 /*break*/, 2];
                return [4 /*yield*/, (0, imageApi_1.default)(String(imageName), Number(imageHeight), Number(imageWidth))];
            case 1:
                newpath = _a.sent();
